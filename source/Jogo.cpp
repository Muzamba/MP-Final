// Copyright 2018 Ariel Batista da Silva
#include "Jogo.h"
#include <iostream>
...
void Jogo::handleEvents() {
    ...
    switch (evento.type) {
        ...
        case SDL_MOUSEMOTION:
            if (menu_inicial) {
                operacao = bIniciar->handleEvent(&evento,
                texturas[BOTAO_INICIAR], texturas[BOTAO_INICIAR_S],
                texturas[BOTAO_INICIAR_P]);
            }
...
void Jogo::update() {
    ...
    // SDL_Surface* textSurface = TTF_RenderText_Solid( font, .c_str(),
    // textColor );
}
